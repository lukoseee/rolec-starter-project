      ...
      <main className= "grid grid-cols-1 bg-[#F6F6F6]">
        ...
        <div>
          <div className="mx-2 lg:mx-68 mt-5">
            <Banner classname = "bg-cover bg-[position:50%_39%] h-60 lg:h-100 text-xs lg:text-lg"  text1=" Morbi rutrum velit sed mollis ornare. Donec viverra" text2="eleifend mi, vel laoreet lorem ut nisi faucibus" button="Lets have a chat!">Topone</Banner>
          </div>
        </div>
